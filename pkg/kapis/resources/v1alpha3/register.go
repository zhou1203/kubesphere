...
func NewHandler(cacheReader runtimeclient.Reader, counter overview.Counter) rest.Handler {
	return &handler{
		resourceGetterV1alpha3: resourcev1alpha3.NewResourceGetter(cacheReader),
